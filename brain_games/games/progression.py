...
def get_question_and_answer():
    quantity_of_numbers_in_question = 10
    start_num = randint(1, 100)
    position_of_indefinite_num = randint(1, quantity_of_numbers_in_question - 1)
    ...
    while index_of_repeats <= quantity_of_numbers_in_question:
